...
/**
 * Central Kafka configuration for the Product Service.
 * <p>
...
public class KafkaConfig {
    ...
    /**
     * Defines and configures the {@link Topics#PRODUCT_COMMANDS_TOPIC}.
     * <p>
    ...
    public NewTopic productCommandsTopic() {
        return TopicBuilder
                .name(Topics.PRODUCT_COMMANDS_TOPIC)
                .partitions(2)
                .replicas(3)
    ...
    /**
     * Defines and configures the {@link Topics#PRODUCT_EVENTS_TOPIC}.
     * <p>
     * This {@link Bean} will cause Spring to automatically create the topic
     * on the broker if it doesn't already exist.
     * <p>
    ...
    public NewTopic productEventsTopic() {
        return TopicBuilder
                .name(Topics.PRODUCT_EVENTS_TOPIC)
                .partitions(2)
                .replicas(3)
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
