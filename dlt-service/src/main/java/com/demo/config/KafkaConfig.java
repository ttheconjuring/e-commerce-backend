...
/**
 * Central Kafka configuration for the Dlt Service.
 * <p>
...
public class KafkaConfig {
    ...
    /**
     * Defines and configures the {@link Topics#UNEXPECTED_ERRORS_TOPIC}.
     * <p>
     ...
     */
    @Bean
    public NewTopic unexpectedExceptionsTopic() {
        return TopicBuilder
                .name(Topics.UNEXPECTED_ERRORS_TOPIC)
                .partitions(2)
                .replicas(3)
