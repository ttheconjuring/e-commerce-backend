...
/**
 * Concrete implementation of the {@link PublisherService} interface.
 * <p>
 * This class uses Spring's {@link KafkaTemplate} to perform the actual
 * asynchronous send operation to Kafka.
 */
@Slf4j
@Component
...
public class PublisherServiceImpl implements PublisherService {
     ...
     * {@inheritDoc}
     * <p>
     * This implementation creates a {@link ProducerRecord} and uses the
     * {@link KafkaTemplate#send(ProducerRecord)} method. It also attaches
     * logging callbacks to the returned future for observability.
     */
    @Override
